...
//     return Message( *this, CREATE_COPY );
  ...
  Message::iterator Message::operator>>( bool& value ) const
  {
  ...
  Message::iterator Message::operator>>( uint8_t& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::iterator Message::operator>>( int16_t& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::iterator Message::operator>>( uint16_t& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::iterator Message::operator>>( int32_t& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::iterator Message::operator>>( uint32_t& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::iterator Message::operator>>( int64_t& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::iterator Message::operator>>( uint64_t& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::iterator Message::operator>>( double& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::iterator Message::operator>>( const char*& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::iterator Message::operator>>( std::string& value ) const
  {
    iterator iter = this->begin();
    iter >> value;
    return iter;
  ...
  Message::append_iterator Message::operator<<( bool value )
  {
  ...
  Message::append_iterator Message::operator<<( uint8_t value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
  ...
  Message::append_iterator Message::operator<<( int16_t value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
  ...
  Message::append_iterator Message::operator<<( uint16_t value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
  ...
  Message::append_iterator Message::operator<<( int32_t value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
  ...
  Message::append_iterator Message::operator<<( uint32_t value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
  ...
  Message::append_iterator Message::operator<<( int64_t value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
  ...
  Message::append_iterator Message::operator<<( uint64_t value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
  ...
  Message::append_iterator Message::operator<<( double value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
  ...
  Message::append_iterator Message::operator<<( const char* value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
  ...
  Message::append_iterator Message::operator<<( const std::string& value )
  {
    append_iterator aiter( *this );
    aiter << value;
    return aiter;
