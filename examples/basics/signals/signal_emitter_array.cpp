...
int main()
{
  ...
  std::shared_ptr<DBus::Signal<void(std::vector<double>) >> signal = connection->create_free_signal<void(std::vector<double>) >("/test/signal/Object", "test.signal.Type", "Test");
