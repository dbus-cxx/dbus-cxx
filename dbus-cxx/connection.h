...
namespace DBus
{
  ...
  class Connection
  {
    ...
    protected:
      ...
      /**
       * Connects to the bus specified by the given address and registers the client with it.
       *
       * @param is_private if true a private connection will be created. Otherwise a shared connection is created.
       * @param address - Address of the bus to connect to.
       */
    ...
    public:
      ...
      static pointer create( std::string address, bool is_private=fales );
