...
public:
    ...
    std::shared_ptr<DBus::signal_proxy<void(std::string, std::string, std::string)>> signal_NameOwnerChanged( );
    std::shared_ptr<DBus::signal_proxy<void(std::string)>> signal_NameLost( );
    std::shared_ptr<DBus::signal_proxy<void(std::string)>> signal_NameAcquired( );
    ...
    std::shared_ptr<DBus::signal_proxy<void(std::string, std::map<std::string, DBus::Variant>, std::vector<std::string>)>> signal_PropertiesChanged( );
...
protected:
    ...
    std::shared_ptr<DBus::signal_proxy<void(std::string, std::string, std::string)>> m_signalproxy_NameOwnerChanged;
    std::shared_ptr<DBus::signal_proxy<void(std::string)>> m_signalproxy_NameLost;
    std::shared_ptr<DBus::signal_proxy<void(std::string)>> m_signalproxy_NameAcquired;
    ...
    std::shared_ptr<DBus::signal_proxy<void(std::string, std::map<std::string, DBus::Variant>, std::vector<std::string>)>> m_signalproxy_PropertiesChanged;
