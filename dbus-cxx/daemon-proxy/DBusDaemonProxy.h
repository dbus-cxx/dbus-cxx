...
protected:
DBusDaemonProxy(std::shared_ptr<DBus::Connection> conn, std::string dest = "org.freedesktop.DBus", std::string path = "/org/freedesktop/DBus" );
public:
    static std::shared_ptr<DBusDaemonProxy> create(std::shared_ptr<DBus::Connection> conn, std::string dest = "org.freedesktop.DBus", std::string path = "/org/freedesktop/DBus" );
    std::string Hello( );
