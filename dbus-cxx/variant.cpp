...
//DBus::Variant Variant::createFromMessage2( MessageIterator* iter ) {
//    Variant v;
//    DBus::Signature sig = iter->get_signature();
//    DBus::DataType dt = sig.begin().type();
//    TypeInfo ti( dt );
//    Marshaling marshal( &v.m_marshaled, DBus::default_endianess() );

//    if(!sig.is_singleton()){
//        std::string msg = "Unable to parse variant: signature ";
//        msg += sig;
//        msg += " is not a single complete type";
//        throw ErrorUnableToParse(msg.c_str());
//    }
...
//    case  DataType::ARRAY:
//        v.recurseArray( sig.begin().recurse(), iter.get, &marshal );
//        break;
...
//        v.recurseStruct( sig.begin().recurse(), iter, &marshal );
//    }
//        break;
...
//void Variant::recurseArray( SignatureIterator sigit, MessageIterator* iter, Marshaling* marshal ) {
//    DataType dt = sigit.type();
//    TypeInfo ti( dt );
//    std::vector<uint8_t> workingData;
//    Marshaling workingMarshal( &workingData, DBus::default_endianess() );
...
//void Variant::recurseDictEntry( SignatureIterator sigit, MessageIterator* iter, Marshaling* marshal ) {
//    marshal->align( 8 );
//    iter->align( 8 );
...
//        case DataType::ARRAY:
//            recurseArray( sigit.recurse(), iter, marshal );
//            break;

//        case DataType::DICT_ENTRY:
//            throw ErrorUnableToParse("Dict entry inside dict entry?!");
//            break;

//        case DataType::VARIANT:
//        {
//            Variant v = Variant::createFromMessage2( iter );
//            marshal->marshal(v);
//        }
//            break;
//        }
